<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="page-header">
                        <h4 class="page-title"> <?php echo e(trans('brands')); ?></h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                            ...
                                            <span style="" class="table-add ">
                                                <a href="<?php echo e(route('admin.brands.create')); ?>" class="btn btn-add btn-block"><?php echo e(trans('new_brand')); ?></a>
                                            </span>
                                ...
                                <div class="table-responsive">
                                    <table id="example-2"
                                        ...
                                        <tr>
                                            ...
                                            <th class="wd-20p"><?php echo e(trans('categories')); ?></th>
                                        ...
                                        <tbody>
                                        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                            <tr>
                                                <td><?php echo e($brand->id); ?></td>

                                                <td>
                                                    <?php echo e($brand->translate('ar')->name); ?>

                                                </td>

                                                <td>
                                                    <?php echo e($brand->translate('en')->name); ?>

                                                </td>

                                                <td>

                                                    <img style="width: 100px" src="<?php echo e(asset($brand->image)); ?>">
                                                ...
                                                <td>
                                                    <label class="custom-switch">
                                                        <input type="checkbox" name="active" id="active"
                                                               data-model="<?php echo e(get_class($brand)); ?>"
                                                               data-id="<?php echo e($brand->id); ?>"
                                                               value="<?php echo e($brand->active); ?>"
                                                               <?php echo e($brand->active ? 'checked' : ''); ?> class="custom-switch-input">
                                                    ...
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item has-icon"
                                                               href="<?php echo e(route('admin.brands.edit', ['brand' => $brand->id])); ?>">
                                                            ...
                                                            <button type="button" class="dropdown-item has-icon"
                                                                    data-toggle="modal"
                                                                    data-target="#exampleModalLong<?php echo e($brand->id); ?>">
    ...
    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <!-- Message Modal -->
            <div class="modal fade" id="exampleModalLong<?php echo e($brand->id); ?>" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo e(route('admin.brands.destroy', ['brand' => $brand])); ?>" method="Post">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/workspace/automarket/resources/views/admin/brands/index.blade.php ENDPATH**/ ?>