<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="page-header">
                        <h4 class="page-title"><?php echo e(trans('questions')); ?></h4>
                    </div>
                </div>
            </div>
            <!--page-header closed-->
                                ...
                                <div class="col-md-2">
                                    <span style="" class="table-add ">
                                            ...
                                            <a href="<?php echo e(route('admin.questions.create')); ?>"
                                               class="btn btn-add btn-block"><?php echo e(trans('add_question')); ?></a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="example-2"
                                        ...
                                        <tbody>
                                        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($question->id); ?></td>
                                                 <td>
                                                   <?php echo e($question->translate('ar')->name); ?>

                                                </td>
                                                <td><?php echo e($question->translate('en')->name); ?></td>
                                                ...
                                                <td>
                                                    <label class="custom-switch">
                                                        <input type="checkbox" name="active" id="active"
                                                               data-model="<?php echo e(get_class($question)); ?>"
                                                               data-id="<?php echo e($question->id); ?>"
                                                               value="<?php echo e($question->active); ?>"
                                                               <?php echo e($question->active ? 'checked' : ''); ?> class="custom-switch-input">
                                                        ...
                                                        <div class="btn-group dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                    ...
                                                                    <a class="dropdown-item has-icon"
                                                                       href="<?php echo e(route('admin.questions.edit', ['question' => $question->id])); ?>"><i
    ...
    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <!-- Message Modal -->
            <div class="modal fade" id="exampleModalLong<?php echo e($question->id); ?>" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo e(route('admin.questions.destroy', ['question' => $question])); ?>" method="Post">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/workspace/automarket/resources/views/admin/questions/index.blade.php ENDPATH**/ ?>