            ...
            <div class="row">
                <div class="col-6">
                    <div class="page-header">
                        <h4 class="page-title">{{ trans('new_sponsor') }}</h4>
                    </div>
                </div>
            </div>
            <!--page-header closed-->
                    ...
                    <div class="col-lg-12 col-xl-6 col-md-12 col-sm-12 mx-auto">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.sponsors.store') }}" method="post" enctype="multipart/form-data" id="horizontal-validation" class="form-horizontal">
                                    @csrf
