...
@section('content')
            ...
            <div class="row">
                <div class="col-6">
                    <div class="page-header">
                        <h4 class="page-title">{{trans('questions')}}</h4>
                    </div>
                </div>
            </div>
            <!--page-header closed-->
                                ...
                                <div class="col-md-2">
                                    <span style="" class="table-add ">
                                            ...
                                            <a href="{{ route('admin.questions.create') }}"
                                               class="btn btn-add btn-block">{{trans('add_question')}}</a>
                                    ...
                                    <table id="example-2"
                                        ...
                                        @foreach ($list as $question)
                                            <tr>
                                                <td>{{ $question->id }}</td>
                                                 <td>
                                                   {{ $question->translate('ar')->name }}
                                                </td>
                                                <td>{{ $question->translate('en')->name }}</td>
                                                ...
                                                <td>
                                                    <label class="custom-switch">
                                                        <input type="checkbox" name="active" id="active"
                                                               data-model="{{  get_class($question) }}"
                                                               data-id="{{ $question->id }}"
                                                               value="{{ $question->active }}"
                                                               {{ $question->active ? 'checked' : '' }} class="custom-switch-input">
                                                        ...
                                                        <div class="btn-group dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                    ...
                                                                    <a class="dropdown-item has-icon"
                                                                       href="{{ route('admin.questions.edit', ['question' => $question->id]) }}"><i
    ...
    @foreach ($list as $question)
        <!-- Message Modal -->
            <div class="modal fade" id="exampleModalLong{{ $question->id }}" tabindex="-1" role="dialog"
