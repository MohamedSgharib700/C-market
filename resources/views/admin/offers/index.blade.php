...
@section('content')
            ...
            <div class="row">
                <div class="col-6">
                    <div class="page-header">
                        <h4 class="page-title"> {{trans('offers')}}</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                            ...
                                            <span style="" class="table-add ">
                                                <a href="{{ route('admin.offers.create') }}" class="btn btn-add btn-block">{{ trans('new_offer') }}</a>
                                            </span>
                                ...
                                <div class="table-responsive">
                                    <table id="example-2"
                                        ...
                                        <tr>
                                            ...
                                            <th class="wd-20p">{{ trans('category') }}</th>
                                            <th class="wd-20p">{{ trans('brand') }}</th>
                                        ...
                                        @foreach ($list as $offer)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{$offer->translate('ar')->name}}
                                                </td>

                                                <td>
                                                    {{$offer->translate('en')->name}}
                                                </td>

                                                <td>

                                                    <img style="width: 100px" src="{{ asset($offer->image) }}">

                                                </td>

                                                <td>

                                                    <label>{{$offer->category->name}}</label>

                                                </td>

                                                <td>

                                                    <label>{{$offer->brand->name}}</label>
                                                ...
                                                <td>
                                                    <label class="custom-switch">
                                                        <input type="checkbox" name="active" id="active"
                                                               data-model="{{  get_class($offer) }}"
                                                               data-id="{{ $offer->id }}"
                                                               value="{{ $offer->active }}"
                                                               {{ $offer->active ? 'checked' : '' }} class="custom-switch-input">
                                                    ...
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <button type="button" class="dropdown-item has-icon"
                                                                    data-toggle="modal"
                                                                    data-target="#exampleModalLong{{ $offer->id }}">
    ...
    @foreach ($list as $offer)
        <!-- Message Modal -->
            <div class="modal fade" id="exampleModalLong{{ $offer->id }}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.offers.destroy', ['offer' => $offer]) }}" method="Post">
                            @method('DELETE')
                            @csrf
