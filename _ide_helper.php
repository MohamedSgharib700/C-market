 ...
 * Generated for Laravel 5.8.35 on 2019-10-23 16:05:36.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function success($payload = array(), $status = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::success($payload, $status);
        }
         ...
         * @static 
         */ 
        public static function fail($message = '', $payload = array(), $status = 500)
        {
                        return \Illuminate\Routing\ResponseFactory::fail($message, $payload, $status);
        }
         ...
         * @static 
         */ 
        public static function e404($message = null)
        {
                        return \Illuminate\Routing\ResponseFactory::e404($message);
        }
         ...
         * @static 
         */ 
        public static function e403($message = null)
        {
                        return \Illuminate\Routing\ResponseFactory::e403($message);
        }
